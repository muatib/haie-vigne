...
<img class="img-up" src="./assets/img/Vector 1.png" alt="">
...
<img class="separation" src="./assets/img/separation.png" alt="separation">


<section class="activity-slider">
    <h2 class="slider-ttl">Les activités de l'association</h2>
    <div class=" slide-container">
        <img class="slide-image" src="./assets/img/yoga.png" alt="yoga">
    ...
    <div class=" slide-container">
        <img class="slide-image" src="./assets/img/fitness.png" alt="fitness">
    ...
    <div class=" slide-container">
        <img class="slide-image" src="./assets/img/pilates.png" alt="pilates">
    ...
    <div class=" slide-container">
        <img class="slide-image" src="./assets/img/stretching.png" alt="stretching">
    ...
    <div class=" slide-container">
        <img class="slide-image" src="./assets/img/gym.png" alt="gym douce">
...
<img class="separation" src="./assets/img/separation.png" alt="">

<section class="price">
    <H2 class="price-ttl">Consuter nos tarifs</H2>
    <a href="./price.php"><button class="price-btn">Tarifs</button></a>
</section>
...
<section class="actuality-slider">
    ...
    <div class=" slider-container">
        <img class="slider-image" src="./assets/img/event.png" alt="event">

        <button class="slide-left-arrow">
            < </button>
    ...
    <div class=" slider-container">
        <img class="slider-image" src="./assets/img/event 2.jpg" alt="event">
    ...
    <div class=" slider-container">
        <img class="slider-image" src="./assets/img/event 3.jpg" alt="event">
